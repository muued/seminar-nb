...
\begin{appendices}
\lstinputlisting[language=C++, caption={KS example in C}, label={code:chisq:r}]{code/ks.c}
\lstinputlisting[language=R, caption={KS example in R}, label={code:chisq:r}]{code/ks.r}
\lstinputlisting[language=C++, caption={$\chi^2$ example in C}, label={code:chisq:r}]{code/chisq.c}
